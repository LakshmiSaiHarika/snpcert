...
class StepLogger:
    ...
    Maintains both a main steps.log and per-guest logs under guest_<id>/steps.log
    for easier debugging when multiple guests are launched.
    ...
    def log_step(
        ...
        *,
        ...
        and vm_stop steps), the step is also logged to guest_<id>/steps.log.
