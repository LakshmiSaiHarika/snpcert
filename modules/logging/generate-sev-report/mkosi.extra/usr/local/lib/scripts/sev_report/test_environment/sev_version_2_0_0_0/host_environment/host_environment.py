...
class HostEnvironment:
    ...
    def get_host_kernel_version(self):
        os_id = self.get_host_os_id()
        kernel_pkg_name = HostOSPackage.host_kernel.get(os_id)
        kernel_command = subprocess.run([self.package_version_path, kernel_pkg_name], capture_output=True, text=True, check=True)
...
# he = HostEnvironment()
# print(he.show_host_environment())